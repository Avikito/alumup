      ...
      <div id="creg-step-4" class="creg-step" style="display:none;">
        ...
        <div style="border:1.5px solid #dde4f0;border-radius:14px;overflow:hidden;margin-bottom:1rem;">
          ...
          <div id="creg-doc-health" style="display:none;padding:1.1rem;border-top:1px solid #e8eef8;">
            ...
            ">
              <strong>הצהרת בריאות — מכללת ALUM-IL</strong><br><br>
              אני המצהיר/ה מאשר/ת כי:<br>
              1. אני כשיר/ה פיזית לביצוע עבודות בגובה (עד 6 מטר) בהתאם לתקנות הבטיחות.<br>
              2. אני מסוגל/ת להרמת משקלים של עד 25 ק"ג ללא הגבלה רפואית.<br>
              3. איני סובל/ת ממחלות לב, לחץ דם גבוה בלתי מאוזן, סחרחורת כרונית או כל מגבלה רפואית אחרת הרלוונטית לעבודות גובה.<br>
              4. אני מתחייב/ת להגיע לאימוני הכשרה פיזית ראשוניים שייקבעו על ידי המכללה.<br>
              5. ידוע לי כי במקרה של שינוי בתנאי הבריאות המפורטים לעיל, עליי להודיע למכללה באופן מיידי.
            </div>
        ...
        <div style="border:1.5px solid #dde4f0;border-radius:14px;overflow:hidden;margin-bottom:1rem;">
          ...
          <div id="creg-doc-regulations" style="display:none;padding:1.1rem;border-top:1px solid #e8eef8;">
            <div style="
              ...
              font-size:0.83rem;color:#1a2640;line-height:1.8;max-height:150px;overflow-y:auto;
            ">
              <strong>תקנון מכללת ALUM-IL — מחזור 2025</strong><br><br>
              <strong>נוכחות:</strong> נוכחות מינימלית של 85% היא תנאי לקבלת תעודה. היעדרות מעל 15% תחייב השלמות.<br><br>
              <strong>דמי רישום וביטוח:</strong> 750 ש"ח כולל ביטוח תאונות אישיות לכל משך ההכשרה.<br><br>
              <strong>מדיניות ביטול:</strong><br>
              • ביטול עד 14 ימים לפני תחילת הקורס — החזר מלא.<br>
              • ביטול 15–30 ימים לפני תחילת הקורס — החזר 50% (375 ש"ח).<br>
              • ביטול פחות מ-30 ימים לפני הקורס או לאחר תחילתו — ללא החזר.<br><br>
              <strong>קוד לבוש:</strong> בגדי עבודה, נעלי בטיחות (S1P לפחות) ומטר אישי — חובה בכל ימי ההכשרה.
            </div>
            <div style="font-size:0.82rem;font-weight:600;color:#1a2640;margin-bottom:8px;">חתמו כאן:</div>
